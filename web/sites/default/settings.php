 ...
 */
 $databases['default']['default'] = array(
  'driver' => 'mysql',
  'database' => 'kruser5_drup8',
  'username' => 'kruser5_kruserme',
  'password' => 'cl2ym0r3',
  'host' => 'localhost',
  'prefix' => '',
);
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_d8training_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_d8training_dd.inc';
}
// </DDSETTINGS>
